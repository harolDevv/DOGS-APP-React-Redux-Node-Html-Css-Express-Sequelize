...
const modelTemperamento = require('./models/Temperamento')
const modelDog = require('./models/Dog')

const sequelize = new Sequelize(`postgres://postgres:harold130696@localhost:5432/dogs`, {
